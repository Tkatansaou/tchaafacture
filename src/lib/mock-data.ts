...
function inv(
  ...
  return { id, customerId, customerName, date, dueDate, subtotal, tax, taxRate, amount, status, notes, items }
}

export const mockInvoices: Invoice[] = [
  inv('INV-001', 'cust-001', 'Amina Diallo', '2025-01-05', '2025-02-04', 350000, 'paid', '', [
  ...
  inv('INV-002', 'cust-002', 'Kofi Mensah', '2025-01-10', '2025-02-09', 520000, 'paid', '', [
  ...
  inv('INV-003', 'cust-004', 'Sébastien Akakpo', '2025-01-18', '2025-02-17', 780000, 'overdue', '', [
  ...
  inv('INV-004', 'cust-011', 'Rokia Sangaré', '2025-01-22', '2025-02-21', 195000, 'paid', '', [
    { description: 'Conseil stratégique', quantity: 5, unitPrice: 39000, total: 195000 },
  ]),
  inv('INV-005', 'cust-003', 'Fatoumata Traoré', '2025-02-01', '2025-03-03', 240000, 'paid', '', [
  ...
  inv('INV-006', 'cust-008', 'Ibrahim Sawadogo', '2025-02-05', '2025-03-07', 410000, 'overdue', '', [
    { description: 'Étude de marché', quantity: 1, unitPrice: 410000, total: 410000 },
  ]),
  inv('INV-007', 'cust-006', 'Mamadou Barry', '2025-02-12', '2025-03-14', 165000, 'paid', '', [
    { description: 'Maintenance applicative', quantity: 1, unitPrice: 165000, total: 165000 },
  ]),
  inv('INV-008', 'cust-002', 'Kofi Mensah', '2025-02-18', '2025-03-20', 630000, 'overdue', '', [
  ...
  inv('INV-009', 'cust-009', 'Nathalie Kouassi', '2025-02-25', '2025-03-27', 285000, 'paid', '', [
    { description: 'Rédaction contenu web', quantity: 10, unitPrice: 28500, total: 285000 },
  ]),
  inv('INV-010', 'cust-004', 'Sébastien Akakpo', '2025-03-03', '2025-04-02', 920000, 'sent', '', [
  ...
  inv('INV-011', 'cust-005', 'Awa Coulibaly', '2025-03-08', '2025-04-07', 142000, 'sent', '', [
    { description: 'Rapport financier Q1', quantity: 1, unitPrice: 142000, total: 142000 },
  ]),
  inv('INV-012', 'cust-007', 'Clarisse Adjobi', '2025-03-15', '2025-04-14', 375000, 'overdue', '', [
  ...
  inv('INV-013', 'cust-001', 'Amina Diallo', '2025-03-20', '2025-04-19', 215000, 'paid', '', [
    { description: 'SEO et référencement', quantity: 1, unitPrice: 215000, total: 215000 },
  ]),
  inv('INV-014', 'cust-011', 'Rokia Sangaré', '2025-03-28', '2025-04-27', 480000, 'sent', '', [
    { description: 'Formation digital marketing', quantity: 1, unitPrice: 480000, total: 480000 },
  ]),
  inv('INV-015', 'cust-008', 'Ibrahim Sawadogo', '2025-04-02', '2025-05-02', 310000, 'sent', '', [
    { description: 'Consulting RH', quantity: 4, unitPrice: 77500, total: 310000 },
  ]),
  inv('INV-016', 'cust-006', 'Mamadou Barry', '2025-04-08', '2025-05-08', 190000, 'sent', '', [
    { description: 'Support niveau 2', quantity: 1, unitPrice: 190000, total: 190000 },
  ]),
  inv('INV-017', 'cust-009', 'Nathalie Kouassi', '2025-04-15', '2025-05-15', 255000, 'overdue', '', [
    { description: 'Gestion réseaux sociaux (1 mois)', quantity: 1, unitPrice: 255000, total: 255000 },
  ]),
  inv('INV-018', 'cust-012', 'Yao Agbéko', '2025-04-22', '2025-05-22', 85000, 'sent', '', [
    { description: 'Création logo et charte graphique', quantity: 1, unitPrice: 85000, total: 85000 },
  ]),
  inv('INV-019', 'cust-003', 'Fatoumata Traoré', '2025-04-28', '2025-05-28', 435000, 'draft', 'À valider avant envoi', [
  ...
  inv('INV-020', 'cust-010', 'Emmanuel Hounkpe', '2025-05-05', '2025-06-04', 180000, 'draft', '', [
